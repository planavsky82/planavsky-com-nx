...
async function loadAPIlData(newPosition) {
  if (!Object.prototype.hasOwnProperty.call(localStorage, 'mffrExpiration') || localStorage.getItem('mffrExpiration') < Date.now()) {
  ...
  if (!Object.prototype.hasOwnProperty.call(localStorage, 'mffrPlayerData')) {
